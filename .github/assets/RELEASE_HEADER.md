...
<details>
<summary>CLICK HERE FOR INSTALL INATRUCTIONS</summary>
...
<img width="746" height="143" alt="Image" src=".github/assets/rpi-imager-step1-open-manifest.png" />

2. Select any device to continue.

<img width="675" height="477" alt="Image" src="../.github/assets/rpi-imager-step2-select-device.png" />

3. Select Internet in a Box as the operating system.

<img width="678" height="480" alt="Image" src="https://raw.githubusercontent.com/chapmanjacobd/iiab/master/.github/assets/rpi-imager-step3-select-os.png" />
